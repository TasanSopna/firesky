...
import {BASE_URL,GET_REJECTED_TIMESHEET_URL} from '../constants/Constants';
...
export default class RejectedTimesheet extends Component {
	 ...
	 <TouchableOpacity>
        <View>
				<Text style={styles.titleFont}>
					<Text style={styles.subHeadings}>Comments :</Text>{item.commentsBymanager}
				</Text>
				<Text style={styles.postBody}>
					<Text style={styles.subHeadings}>RejectedDate :</Text>{item.rejectedDate}
				</Text>
  ...
  fetchData = async (id) => {
    var url = BASE_URL+GET_REJECTED_TIMESHEET_URL+id;
		fetch(url, {
		  method: 'Get',
		  headers: new Headers({
